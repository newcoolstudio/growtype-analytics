...
trait Growtype_Analytics_Admin_Page_Metrics_Trait
{
    ...
    public function get_registered_users_list_data($days, $paged = 1, $per_page = 50, $filters = [], $orderby = '', $order = 'DESC')
    {
        return $this->users_metrics->get_registered_users_list($days, $paged, $per_page, $filters, $orderby, $order);
    }
}
